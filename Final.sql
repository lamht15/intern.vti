...
DROP DATABASE IF EXISTS TestingSystem_Final;
-- Create database
CREATE DATABASE IF NOT EXISTS TestingSystem_Final;
USE TestingSystem_Final;
...
VALUES 				(	'dangblack'		,   '$2a$10$W2neF9.6Agi6kAKVq8q3fec5dHW8KUA.b0VSIGdIZyUravfLpyIFi'	,	'Nguyen Hai'	,	'Dang'		,		'ADMIN'		,		'5'			),
                    ...
                    (	'thanhlamuit'	,   '$2a$10$W2neF9.6Agi6kAKVq8q3fec5dHW8KUA.b0VSIGdIZyUravfLpyIFi'	,	'Hoang'			,	'Thanh Lam'	,		'EMPLOYEE'	,		'4'			),
                    (	'hailinhueh'	,   '$2a$10$W2neF9.6Agi6kAKVq8q3fec5dHW8KUA.b0VSIGdIZyUravfLpyIFi'	,	'Nguyen '		,	'Nu Hai Linh',		'ADMIN'		,		'8'			);